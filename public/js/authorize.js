...
--------------------------------------------
 */
var DMHandler, Giccoo, SHAKE_THRESHOLD, deviceMotionHandler, gico, last_update, last_x, last_y, last_z, _x, _y, _z;
...
/*
--------------------------------------------
     Begin authorize.coffee
--------------------------------------------
 */

document.addEventListener('WeixinJSBridgeReady', function() {
  return window.location.href = $("#newpage").attr("href");
});
